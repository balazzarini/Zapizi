...
app.post('/api/submit', async (req, res) => {
    ...
    const mailOptions = {
        from: '"Avaliação CS Zapizi" <onboarding@resend.dev>', // Endereço padrão de teste do Resend
            ...
            <pre><code>
{
  ...
  "perfil_predominante": "${predominant}"
            ...
            <hr>
            <p><small>Este e-mail foi gerado automaticamente pelo sistema de avaliação CS Zapizi.</small></p>
        `
    };
...
app.listen(port, () => {
    console.log(`🚀 Zapizi CS Test App running on http://localhost:${port}`);
});
